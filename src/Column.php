...
final class Column
{
     ...
     *
     */
    public function withSum(string $label = '', bool $header = true, bool $footer = true, int $rounded = 2): Column
    {
     ...
     *
     */
    public function withCount(string $label = '', bool $header = true, bool $footer = true): Column
    {
     ...
     *
     */
    public function withText(string $label = '', bool $header = true, bool $footer = true): Column
    {
    ...
    * Hide the column
    ...
    public function makeInputSelect(Collection $datasource, string $displayField, string $dataField = null, array $settings = []): Column
    {
        ...
        $this->inputs['select']['all']           = true;

        return $this;
    }

    /**
     * Input Select Filter Without All
     *
     */
    public function makeInputSelectWithoutAll(Collection $datasource, string $displayField, string $dataField = null, array $settings = []): Column
    {
        $this->editable                          = false;
        $this->inputs['select']['data_source']   = $datasource;
        $this->inputs['select']['displayField']  = $displayField;
    ...
    public function makeInputMultiSelect(Collection $datasource, string $optionText, string $dataField = null, string $optionValue = 'id'): Column
    {
        ...
        $this->inputs['multi_select']['all']           = true;
        $this->inputs['multi_select']['single']        = false;

        return $this;
    }

    /**
     * Input Multi-Select Filter Without All
     *
     */
    public function makeInputMultiSelectWithoutAll(Collection $datasource, string $optionText, string $dataField = null, string $optionValue = 'id'): Column
    {
        $this->editable                                = false;
        $this->inputs['multi_select']['data_source']   = $datasource;
        $this->inputs['multi_select']['text']          = $optionText ?: $optionValue;
        $this->inputs['multi_select']['value']         = $optionValue;
        $this->inputs['multi_select']['dataField']     = $dataField;
        $this->inputs['multi_select']['all']           = false;
        $this->inputs['multi_select']['single']        = false;
    ...
    /**
     * Input Multi-Select Filter Single
     *
     */
    public function makeInputMultiSelectSingle(Collection $datasource, string $optionText, string $dataField = null, string $optionValue = 'id'): Column
    {
        $this->editable                                = false;
        $this->inputs['multi_select']['data_source']   = $datasource;
        $this->inputs['multi_select']['text']          = $optionText ?: $optionValue;
        ...
        $this->inputs['multi_select']['dataField']     = $dataField;
        $this->inputs['multi_select']['all']           = true;
        $this->inputs['multi_select']['single']        = true;
