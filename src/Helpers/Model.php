...
class Model implements ModelFilterInterface
{
    ...
    public function filterInputText(Builder $query, string $field, $value): void
    {
        ...
        // changes input text options to input_option_text
        $textFieldOperator = (validateInputTextOptions($this->filters, $field) ? strtolower($this->filters['input_option_text'][$field]) : 'contains');
