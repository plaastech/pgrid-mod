...
class PowerGridComponent extends Component
{
    ...
    /** @var \Illuminate\Support\Collection $withPaginatedData */
    public $withPaginatedData;
    ...
    public function fillData()
    {
        ...
        if ($this->isCollection) {
            ...
            if ($this->headerTotalColumn || $this->footerTotalColumn) {
                $this->withPaginatedData = $results->values()
                    ->map(fn ($item) => (array) $item);
            }
        ...
        if ($this->headerTotalColumn || $this->footerTotalColumn) {
            $this->withPaginatedData = $this->transform($results->getCollection());
        }
